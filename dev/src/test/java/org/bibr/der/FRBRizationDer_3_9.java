...
public class FRBRizationDer_3_9 {
	...
	public void tearDown() throws Exception{
		String path = Util.path+"/3_Derivation/3.9/der-missing-authoritative-responsibility-frbr.xml";
	...
	public void aventuresTomSawyer() {
		...
		translator1.addProperty(FRBR.nameOfThePerson(model), "P. F. Caille");
		
		// Translator 2
		Resource translator2 = FRBR.person(model,"DuboisMauvaisY");
		translator2.addProperty(FRBR.nameOfThePerson(model), "Y. Dubois-Mauvais");
