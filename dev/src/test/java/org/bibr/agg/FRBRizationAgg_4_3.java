...
public class FRBRizationAgg_4_3 {
	...
	public void tearDown() throws Exception {
		...
		String path = Util.path+"/4_Aggregation/4.3/agg-missing-type-form-material-frbr.xml";
	...
	public void romanDeRenart() {
		...
		partauthor.addProperty(FRBR.identifierForThePerson(model), "pauth-026");
	...
	public void meditationsMetaphysiques() {
		...
		collab1.addProperty(FRBR.identifierForThePerson(model), "pauth-010");
		...
		collab2.addProperty(FRBR.identifierForThePerson(model), "pauth-056");
