...
public class FRBRizationCom_5_9 {
	...
	public void tearDown() throws Exception {
		...
		String path = Util.path+"/5_Complementary/5.9/comp-missing-authoritative-responsibility-frbr.xml";
	...
	public void dCGEpreuve10() {
		...
		author1.addProperty(FRBR.nameOfThePerson(model), "Odile Barbe");
		...
		expression1.addProperty(FRBR.editor(model), author1);
	...
	public void aStudyInContinualImprovement() {
		...
		author2.addProperty(FRBR.nameOfThePerson(model), "W. Edwards Deming");
